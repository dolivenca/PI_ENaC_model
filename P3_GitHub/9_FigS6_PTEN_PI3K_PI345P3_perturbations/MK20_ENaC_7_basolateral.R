### Model ###
### This simulates the basolateral part of the plasma membrane of human bronquial epithelial cell  ###

# for basolateral multiply gammaPTENc_PTENa by 10
...
HS = function (PA)(1 + 2*PA^2/(PA^2+10000^2)) 	# This is a modified Hill function that translates PA regulation on PIP5KI

# this function represents the regulation of PI(4,5)P2 in the open probability of ENaC
...
parameters=c(parameters,
		...
		gammaPTENc_PTENa = mp3_PTEN * 4.166667e-05/10, fPTENc_PTENa_PTEN_c = 1, fPTENc_PTENa_PI45P2 = 1, 
...
equations=function(t,state,parameters) 	# function containing the diferential equations
	{with(as.list(c(state,parameters)),
		...
		dPI = V_0 + V3_0a + V3_0c + V3_0d + V3_0e + V4_0a + V4_0c + V5_0a  + V5_0c + V45_0 - V0_3a - V0_3b - V0_3c - V0_4 - V0_5 - V0_ - V0_45 #- V_PI_DAG
...
out = Cruncher(state,t,equations,parameters,perturbations)  	# solving th ODEs
# edit(out)
# View(out)
...
# tiff("fig_S7b.tiff", height = 20, width = 34, units = 'cm',compression = "lzw", res = 300)
windows()
par(mfrow=c(3,4))
for (i in c(15,16)) 
	{
	plot(out_norm[,1],out_norm[,i],
	type='l',col=varcolors[i],
	xlab='Time (min)',ylab='Fold change',main=varnames[i],
	xlim=c(0,60),ylim=c(.85,1),
	lwd=3,cex.axis=1.5,cex.lab=1.5,cex.main=2)
