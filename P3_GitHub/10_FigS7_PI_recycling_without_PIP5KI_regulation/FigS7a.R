...
equations=function(t,state,parameters) 	# function containing the diferential equations
	{with(as.list(c(state,parameters)),
		...
		dPI = V_0 + V3_0a + V3_0c + V3_0d + V3_0e + V4_0a + V4_0c + V5_0a  + V5_0c + V45_0 - V0_3a - V0_3b - V0_3c - V0_4 - V0_5 - V0_ - V0_45 + VPA_
...
# tiff("P2F2_Fig_cycle_a.tiff", height = 20, width = 34, units = 'cm',compression = "lzw", res = 300)
