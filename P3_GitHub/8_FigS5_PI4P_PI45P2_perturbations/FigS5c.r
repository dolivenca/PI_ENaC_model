### Please run model first ###### Run model in apical configuration first ###
...
Vernai_data_5_phosphatase = read.csv("Varnai_data_5_phosphatase_PI4P_PI45P2.csv")
setwd(wd)

# tiff("P2F2_Fig_2_Vernai_2.tiff", height = 20, width = 34, units = 'cm',compression = "lzw", res = 300)
windows()
par(mar=c(5,6,4,5)+.1)
plot(Vernai_data_5_phosphatase$X,Vernai_data_5_phosphatase$PI45P2,
	type='p',col='red',pch=19,
	xlim=c(-5,20),ylim=c(0,120),
	main='5 phosphatase activation',
	xlab='Time (min)',ylab='percentage fold change',
	cex.main=3, cex.lab=3, cex.axis=2, cex=2
	)
points(Vernai_data_5_phosphatase$X,Vernai_data_5_phosphatase$PI4P,type='p',col='blue',pch=19,cex=2)
